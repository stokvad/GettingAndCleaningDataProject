...
## The data
# The raw data
The raw data is placed in subfolder "raw data". This contains both the zip file and the unzipped folder "UCI HAR Dataset", from which the scripts shall load when rerunning the scripts.

The source data can be downloaded again with the getrawdata.R script.
...
# Linking the files
The X_train.txt file contains the data from each activity. The type of activity for each activity is in the file y_train.txt, and the subject who performed each activity is in the subject_train.txt file.
The files has to be joined by row number to merge the data.
The column names for each file is in features.txt and activity_labels.txt. The subject file has no column name file, as this contains only the subject number in the study.
...
"1","activityId", id of the type of activity
"2","tBodyAcc.mean...X"
"3","tBodyAcc.mean...Y"
"4","tBodyAcc.mean...Z"
"5","tBodyAcc.std...X"
...
"81","subject", id-number of the subject who performed the activity
"82","activityLabel", the name of the activity performed


## Data transformations

This can all be done with the script "cleanupdata.R" by executing the function "cleanupData()".
